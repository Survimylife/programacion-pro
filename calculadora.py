...
botonC = Button(miFrame, text='C', width=6, height=2, font=("Times", 10))
botonC.grid(row=3,column=5)

botonErase = Button(miFrame, text='⌫', width=6, height=2)
...
boton_equal = Button(miFrame, text='=', width=6, height=2)
boton_equal.grid(row=5,column=6)
